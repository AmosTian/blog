---
title: 1.准备知识1——相似&换位公式&秩1矩阵&内积&正交
categories:
  - 数学
  - 矩阵论
tags:
...
&(A,A)=tr(AA^H)=tr(A^HA)=\sum a_{ij}\overline{a_{ij}}=\sum \vert a_{ij} \vert^2
\end{aligned}
$$
...
&=\overline{\overline{x_1}y_1+\overline{x_2}y_2+\cdots+\overline{x_n}y_n}\\=(Y,X)
\end{aligned}
$$
...
$$
\begin{aligned}
A是预U阵且 \vert \alpha_1 \vert=\cdots=\vert \alpha_n \vert=1,则A是一个U阵(正交阵)
\end{aligned}
$$
