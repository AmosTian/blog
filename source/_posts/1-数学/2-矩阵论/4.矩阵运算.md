...
![image-20221129084538015](4.矩阵运算/image-20221129084538015.png)
...
![image-20221130204119310](4.矩阵运算/image-20221130204119310.png)
...
A有特解 $A_0=A^+=\left(1,0,0\right)_{1\times 3}$ ，通解公式为 $X=A^++(Y-A^+AYAA^+)$ Y与 $A^+$ 同型即 $Y=Y_{1\times 3}$ 
