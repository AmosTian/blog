...
![](5-IO管理/image-20220313110258751.png)
...
![](5-IO管理/image-20220313110633406.png)
...
![](5-IO管理/image-20220313205904220.png)
...
![](5-IO管理/image-20220312152816363.png)
...
![](5-IO管理/image-20220312155337135.png)
...
![](5-IO管理/image-20220312180101597.png)

###### 系统设备表(SDT)

记录系统中全部设备的情况

![](5-IO管理/image-20220312192022285.png)

###### 设备控制表(DCT)

每个设备一张设备控制表

![](5-IO管理/image-20220312182218626.png)

###### 控制器控制表(COCT)

每个设备控制器一张控制器控制表

![](5-IO管理/image-20220312185248715.png)
###### 通道控制表（CHCT）
...
![](5-IO管理/image-20220312185515567.png)
...
![](5-IO管理/image-20220312193851250-16613053979362.png)
...
![](5-IO管理/image-20220313080637736.png)
...
![](5-IO管理/image-20220313083029098.png)
此时处理一块数据的 $平均用时=T+M$ 
...
![](5-IO管理/image-20220313083126414.png)

此时处理一块数据的 $平均用时=C+M$ 

**单缓冲区间的通信**

![](5-IO管理/image-20220313090459716.png)
...
![](5-IO管理/image-20220313090138811.png)
...
![](5-IO管理/image-20220313090539547.png)

###### 循环缓冲区

>   将多个大小相等的缓冲区链接成一个循环队列

![](5-IO管理/image-20220313090629499.png)

##### d. 缓冲池

###### 三个队列四个区

![](5-IO管理/image-20220313100326723.png)
...
![](5-IO管理/image-20220313100518006.png)
...
![](5-IO管理/image-20220313102629870.png)

###### 计算进程将数据输出到输出缓冲区

从空缓冲队列中取出一块作为 *收容输出数据的工作缓冲区(hout)* ，缓冲区冲满后挂到输出队列队尾

![](5-IO管理/image-20220313102955712.png)

###### 输出进程请求输出数据

从输出队列中取得一块冲满的 *输出数据的工作区(sout)*

![](5-IO管理/image-20220313103123818.png)
