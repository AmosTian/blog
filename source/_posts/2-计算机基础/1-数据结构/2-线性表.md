...
>
>           ![](2-线性表/image-20220124121623414.png)
>
...
![](2-线性表/image-20220124172446352.png)
...
![](2-线性表/image-20220122195235320.png)
...
![](2-线性表/image-20220124185509245.png)
...
![](2-线性表/image-20220124193849811.png)

失配原因是 $S[k+4]\neq P[4]$ ，但前缀

![](2-线性表/image-20220124194720668.png)
...
![](2-线性表/image-20220124202604073.png)

<div STYLE="page-break-after: always;"></div>

##### `next[j]` 怎样应用算法实现

（1）若 `P[j] == P[next[j]]` ，则其 `next[j+1] = next[j]+1`

![](2-线性表/image-20220124223844512.png)
...
![](2-线性表/image-20220124233748401.png)
...
![](2-线性表/image-20220125093841548.png)
...
-   缺陷：*假上溢* 
    ...
    ![](2-线性表/image-20220125102922240.png)
...
![](2-线性表/image-20220125112441908.png)
...
![](2-线性表/image-20220125222539554.png)
...
![](2-线性表/image-20220125224019771.png)

![](2-线性表/image-20220125224111965.png)
...
![](2-线性表/image-20220126180218361.png)
...
![](2-线性表/image-20220126182807378.png)
...
![](2-线性表/image-20220126192811630.png)
