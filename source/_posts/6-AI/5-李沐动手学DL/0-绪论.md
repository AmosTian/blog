...
![image-20240314110304059](0-绪论/image-20240314110304059.png)
...
|                          | $x_{1\times \cdot}$                                        | $\mathbf{x}_{n\times 1}$                                     |
| :----------------------- | ---------------------------------------------------------- | ------------------------------------------------------------ |
| $y_{1\times \cdot}$      | 标量： $\frac{\partial y}{\partial x}_{1\times \cdot}$     | 向量：$\frac{\partial y}{\partial \mathbf{x}}_{1\times n}$   |
| $\mathbf{y}_{m\times 1}$ | 向量：$\frac{\partial \mathbf{y}}{\partial x}_{m\times 1}$ | 矩阵：$\frac{\partial \mathbf{y}}{\partial \mathbf{x}}_{m\times n}$ |

![image-20240316102524253](0-绪论/image-20240316102524253.png)

- 此处采用分子布局，$\mathbf{x}_{n\times 1}$ ，$\frac{\partial y}{\partial \mathbf{x}}_{1\times n}$ 为行向量：向量大小为逐元素求偏导，方向垂直与等值线

- ![image-20240316102930111](0-绪论/image-20240316102930111.png)

  对于内积运算 $(\mathbf{u},\mathbf{v})$ ，$\mathbf{u}^T,\mathbf{v}^T$ 为行向量，所以最终也是行向量

![image-20240316103622364](0-绪论/image-20240316103622364.png)
...
|                          | $x_{1}$                                                      | $\mathbf{x}_{p\times 1}$                                     | $\mathbf{X}_{p\times q}$                                     |
| ------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| $y_{1}$                  | 标量： $\frac{\partial y}{\partial x}_{1}$                   | 向量：$\frac{y}{\partial x}_{1\times 1\times p=1\times p}$   | 矩阵：$\frac{\partial y}{\partial X}_{1\times q\times p= q\times p}$ |
| $\mathbf{y}_{m\times 1}$ | 向量：$\frac{\partial \mathbf{y}}{\partial x}_{m\times 1\times 1=m\times 1}$ | 矩阵：$\frac{\partial \mathbf{y}}{\partial \mathbf{x}}_{m\times1\times1\times p=m\times p}$ | 矩阵：$\frac{\partial \mathbf{y}}{\partial \mathbf{X}}_{m\times 1\times q\times p=m\times q\times p}$ |
| $\mathbf{Y}_{m\times n}$ | 矩阵：$\frac{\partial \mathbf{Y}}{\partial x}_{m\times n\times 1=m\times n}$ | 矩阵：$\frac{\partial \mathbf{Y}}{\partial \mathbf{x}}_{m\times n\times 1\times p=m\times n\times p}$ | batch：$\frac{\partial \mathbf{Y}}{\partial \mathbf{X}}_{m\times n\times p\times q}$ |

|                          | $x_{1}$                                                      | $\mathbf{x}_{1\times q}$                                     | $\mathbf{X}_{p\times q}$                                     |
| ------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| $y_{1}$                  | 标量： $\frac{\partial y}{\partial x}_{1}$                   | 向量：$\frac{y}{\partial \mathbf{x}}_{1\times 1\times q=1\times q}$ | 矩阵：$\frac{\partial y}{\partial X}_{1\times p\times q= p\times q}$ |
| $\mathbf{y}_{1\times m}$ | 向量：$\frac{\partial \mathbf{y}}{\partial x}_{m\times 1\times 1=m\times 1}$ | 矩阵：$\frac{\partial \mathbf{y}}{\partial \mathbf{x}}_{m\times1\times1\times q=m\times q}$ | 矩阵：$\frac{\partial \mathbf{y}}{\partial \mathbf{X}}_{m\times 1\times p\times q=m\times p\times q}$ |
| $\mathbf{Y}_{n\times m}$ | 矩阵：$\frac{\partial \mathbf{Y}}{\partial x}_{m\times n\times 1=m\times n}$ | 矩阵：$\frac{\partial \mathbf{Y}}{\partial \mathbf{x}}_{m\times n\times 1\times q=m\times n\times q}$ | batch：$\frac{\partial \mathbf{Y}}{\partial \mathbf{X}}_{m\times n\times p\times q}$ |
