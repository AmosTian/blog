...
>
> [SpringBoot](https://amostian.github.io/posts/1864766114/)
>
> [微服务](https://amostian.github.io/posts/1175195952/)
>
> [Dubbo](https://amostian.github.io/posts/4129633176/)
...
![](2-后台系统/image-20210317155702868.png)
...
![](2-后台系统/image-20210316150113220.png)
...
![](2-后台系统/image-20210318101526639.png)
...
![](2-后台系统/image-20210320152904298.png)
...
![](2-后台系统/image-20210320222151968.png)
...
![](2-后台系统/image-20210321101340465.png)

![](2-后台系统/image-20210321130341760.png)
...
![](2-后台系统/image-20210324162830267.png)
...
![](2-后台系统/image-20210325112409709.png)
...
![](2-后台系统/image-20210325115643885.png)
...
![](2-后台系统/image-20210325133234793-16487887911294.png)
...
![](2-后台系统/image-20210327104220902-16487887782013.png)

由GraphQL的调用流程可知，传入到后端的GraphQL字符串最终会被构造成一个 `ExecutionInput` 对象

![](2-后台系统/image-20210327103900120.png)
...
![](2-后台系统/image-20210327170512039.png)
...
```
![](2-后台系统/image-20210328100647147.png)
...
![](2-后台系统/image-20210318231205448.png)
...
![](2-后台系统/image-20210319094707779.png)
...
![](2-后台系统/image-20210329214817311.png)
```shell
#停止容器
docker stop redis-node01 redis-node02 redis-node03
#删除容器
...
![](2-后台系统/image-20210329220126931.png)
...
![](2-后台系统/image-20210330092907260.png)
...
![](2-后台系统/image-20210330200516377.png)
