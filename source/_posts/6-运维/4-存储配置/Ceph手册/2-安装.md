...
解决liboath
wget https://download-ib01.fedoraproject.org/pub/epel/8/Everything/x86_64/Packages/l/liboath-2.6.12-1.el8.x86_64.rpm
...
ceph.conf  rbdmap  tmp71bbjebz

[root@node1 ceph-cluster]# cp *.keyring /etc/ceph/
[root@node1 ceph-cluster]# ceph -s
  cluster:
    id:     b206b31c-d9b1-412d-83da-f21e3212a6d8
    health: HEALTH_OK
 
  services:
    mon: 1 daemons, quorum node1 (age 113s)
...
cephadm@admin:~/ceph-cluster$ ceph-deploy disk list node1
```
