...
[cephfs架构](https://www.yangguanjun.com/2017/08/30/cephfs-knowledge-share-part1/)

客户端挂载方式不同，IO路径也存在较大差异，cephfs-fuse的IO路径比较长，性能会比cephfs kernel module的方式差一些；

![cephfs-intro-fun1](5.存储配置/cephfs-intro-fun1.jpg)

**客户端访问cephfs的流程**

![ceph-used-in-cloudin7](5.存储配置/ceph-used-in-cloudin7.jpg)
...
![cephfs-component-communication](5.存储配置/cephfs-component-communication.jpg)
...
[关于cephfs的测试](https://www.yangguanjun.com/2017/07/16/cephfs-test-method-lite/)
