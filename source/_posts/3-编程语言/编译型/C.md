...
![](C/image-20230323221304853.png)

![](C/image-20230323221241723.png)
...
![](C/image-20230323221646176.png)

>   一个指针就是**一个内存单元的地址**
>
>   变量地址：系统分配给变量的 “内存单元” 的**起始地址**

![](C/image-20230323221709119.png)

#### b. 指针变量

在C语言中，允许用一个变量来存放其它变量的地址，即指针变量

![](C/image-20230323221731475.png)
...
![image-20220803111940768](C/fe72fbde4eb9441eb7b84574b9a713fa-16795811007871.png)
...
![](C/dd065bb91e33462ea893f39f8c2b52c2-16795811089853.png)
...
![](C/2efedf2095a746e291528b9e9195951b-16795811391765.png)
...
生命周期：从程序运行到定义那一行开始分配存储空间，到程序离开该变量所在的作用域
...
- 当定义静态局部变量所在的块结束，其作用域随之结束 

![](C/8806d5f7d2a94b80aa4fe511ce498a67.png)
...
## 5.1 顺序结构
![](C/7dc2ab55e7dd4c06be094a08a1501ba3.png)

## 5.2 选择结构

![](C/189980520d2b4c4ca8664b75fcb966db.png)
...
![](C/d1b7b92324024a809ae7748bc0e76397.png)
...
![在这里插入图片描述](C/f5288d8837e04564be685cc16486a57d.png)
...
涉及数据结构的线性表，可自行查看：https://amostian.github.io/posts/3975030669/
